...
import { generarCiudades, agregarFiltroInput } from './utils.js';

generarCiudades(stays, cityList, contenedor, modal1);

const inputCiudad = document.getElementById("locationInput");
agregarFiltroInput(inputCiudad, stays, contenedor, modal1);
